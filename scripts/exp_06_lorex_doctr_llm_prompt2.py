# scripts/exp_07_doctr_llm_all160_prompt2.py
...
OUT_PATH = Path("results/doctr_llm_160_prompt2.json")
FAILED_PATH = Path("results/doctr_llm_160_prompt2_failed.json")
...
# OCR
# =========================
def ocr_doctr(img_path: Path) -> str:
