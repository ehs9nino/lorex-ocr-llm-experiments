# scripts/exp_08_openocr_llm_all160_prompt2.py
...
OUT_PATH = Path("results/openocr_llm_160_prompt2.json")
FAILED_PATH = Path("results/openocr_llm_160_prompt2_failed.json")
...
# OCR
# =========================
def ocr_openocr(img_path: Path) -> str:
    result = ocr.model(img_path=str(img_path), is_visualize=False)
