# scripts/exp_04_paddle_llm_all160_prompt2.py
...
OUT_PATH = Path("results/paddle_llm_160_prompt2.json")
FAILED_PATH = Path("results/paddle_llm_160_prompt2_failed.json")
...
# OCR
# =========================
def ocr_paddle(img_path: Path) -> str:
